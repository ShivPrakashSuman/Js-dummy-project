        ...
        <div class="mane">
            <div class="fom">
                <div class=" p-5 text-center" style="margin: 25px;" >
                    ...
                    <form action="login_store.php" method="post" style="font-size:15px;" >

                        <div class="form-outline mb-4 pb-4 pt-4">
                            <spam class="text-danger"> <?php echo (isset($_GET['isEmail']) && $_GET['isEmail'] == 1 )?'your Emaile was incorrect. ':'';?> </span>
                            <input type="email" class="form-control inr" name="email" placeholder="Email address" required>
                        </div>

                        <div class="form-outline mb-4 pb-4 ">
                        <spam class="text-danger"> <?php echo (isset($_GET['isPassword']) && $_GET['isPassword'] == 1 )?'your Password was incorrect. ':'';?> </span>
