                    ...
                    <div class="shadow-lg ">
                        ...
                        <div class="row p-4">
                            <table class="table table-striped table-hover table ">
                                <?php
                                    include('../../include/db.php');
                                    $sql = "select*from cat_data2";
                                    if(isset($_GET['search'])) {
                                        $search = $_GET['search'];
                                        $sql = "SELECT * FROM cat_data2 WHERE brand LIKE '%$search%' or description LIKE '%$search%' or status LIKE '%$search%' ";
                                    }
                                ...
                                <tr >
                                    ...
                                    <td> <div class="overflow"><p><?php echo $rowData['brand']; ?></p></div></td>
