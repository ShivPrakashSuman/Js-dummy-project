                        ...
                        <div class="row">   
                            <form action="" method="get">
                                ...
                                <div class="col-sm-6 p-0">
                                    ...
                                    <a href="http://localhost/ajax_js/JS_blog/backend/blog/" class="reset" >Reset</a>
                                </div>
                            </form>
                        </div> 
                    </div>
                ...
                if(resp.status){
                    ...
                    if(resp.data.data.length > 0){
                        resp.data.data.forEach((val, key)=>{
                            html += '<tr>'+
                                        '<td>'+ val.id +'</td>'+
                                        '<td> <div class="overflow"><p>'+ val.title +'</p></div></td>'+
                                        '<td> <div class="overflow">'+ val.description +'</div></td>'+
                                        '<td> <img src="../../uploads/'+ val.image +'" width="80px" height="80px"> </td>'+
                                        '<td>' + val.status + '</td>'+
                                        '<td> '+ val.created +' </td>'+
                                        '<td>'+
