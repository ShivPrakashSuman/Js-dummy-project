                        ...
                        <div class="shadow-lg ">
                            ...
                            <div class="row p-4">
                                <form class= "form p-4" action="edit_store.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="text" class="form-control "  placeholder="Enter Title" name="title" style="font-size:18px;" value="<?php echo $datarow['title']; ?>" required > <br>
                                    <textarea name="description"  class="form-control input2" id="editor1" required ><?php echo $datarow['description']; ?></textarea><br>
                                    <input type="file" class="form-control bor"  placeholder="Enter File" name="file" style="font-size:17px;" value="<?php echo $datarow['image']; ?>" required > <br> 
                                    <div class="text-secondary">
                                        Status :	
                                        <input type="radio" name="status" value="yes"  <?php echo $datarow['status'] == 'yes'?'checked':''; ?> required>
                                        <lable for="yes"> Yse </lable>
                                        <input type="radio" name="status" value="no" <?php echo $datarow['status'] == 'no'?'checked':''; ?> required>
